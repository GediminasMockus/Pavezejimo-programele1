...
const EN: Record<string, string> = {
  ...
  'Pakeleivingi maršrutai': 'Routes along your way', 'Tikrinami pakeleivingi maršrutai pagal realius kelius…': 'Checking routes along your way using real roads…',
  'Vairuotojas važiuoja kitu maršrutu, tačiau gali paimti ir išlaipinti pakeliui.': 'The driver has a different route but can pick you up and drop you off along the way.',
  'Gali paimti su nedideliu apvažiavimu': 'Can pick you up with a small detour',
  'Pakeleivingų maršrutų šiuo metu patikrinti nepavyko. Pabandykite paiešką dar kartą.': 'Routes along your way could not be checked right now. Please try the search again.',
  'Abi vietos beveik prie vairuotojo kelio': 'Both places are very close to the driver’s route', 'Abi vietos iki 15 km nuo vairuotojo kelio': 'Both places are within 15 km of the driver’s route',
  'Tinkama važiavimo kryptis': 'Correct direction of travel', 'Nedidelis papildomas apvažiavimas': 'Small additional detour', 'Priimtinas papildomas apvažiavimas': 'Acceptable additional detour',
  'Tinkamas pravažiavimo laikas': 'Suitable passing time', 'Pakanka vietų': 'Enough seats',
  'Paėmimo ir išlaipinimo vietos užpildytos pagal jūsų paiešką. Jei reikia, galite jas patikslinti.': 'Pickup and drop-off were filled from your search. You can adjust them if needed.',
...
const patterns: Array<[RegExp, (m: RegExpMatchArray) => string]> = [
  ...
  [/^Pakeleivingi maršrutai \((\d+)\)$/, m => `Routes along your way (${m[1]})`],
  [/^Papildomai apie (\d+) km · (\d+) % maršruto$/, m => `About ${m[1]} km extra · ${m[2]}% of the route`],
